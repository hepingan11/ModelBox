...
public class DrawingController {
    ...
    @PostMapping(value = "/gpt/text", name = "(GPT)绘图接口", consumes = "application/json", produces = MediaType.APPLICATION_JSON_VALUE)
    @UserLastOperationTime
    public Result addTask(@Valid DrawingGptTextDto dto) {
        return Result.data(drawingService.publishDrawingTask(dto));
    }
