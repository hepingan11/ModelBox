...
public class WXPayUtility {
    ...
    private static String readKeyStringFromPath(String keyPath) {
        try {
            // 使用类路径加载资源
            InputStream inputStream = WXPayUtility.class.getClassLoader().getResourceAsStream(keyPath);
            if (inputStream == null) {
                throw new FileNotFoundException("Resource file not found in classpath: " + keyPath);
            }
